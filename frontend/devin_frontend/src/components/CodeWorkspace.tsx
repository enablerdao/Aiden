...
export function CodeWorkspace() {
  ...
  const [fileTree, setFileTree] = useState<FileNode[]>([
    {
      name: 'devin-system',
      path: '/home/ubuntu/devin-system',
      type: 'directory',
      expanded: true,
      children: [
        {
          name: 'frontend',
          path: '/home/ubuntu/devin-system/frontend',
          type: 'directory',
          expanded: true,
          children: [
            {
              name: 'devin_frontend',
              path: '/home/ubuntu/devin-system/frontend/devin_frontend',
              type: 'directory',
              expanded: true,
              children: [
                {
                  name: 'src',
                  path: '/home/ubuntu/devin-system/frontend/devin_frontend/src',
                  type: 'directory',
                  expanded: true,
                  children: [
                    {
                      name: 'App.tsx',
                      path: '/home/ubuntu/devin-system/frontend/devin_frontend/src/App.tsx',
                      type: 'file'
                    },
                    {
                      name: 'main.tsx',
                      path: '/home/ubuntu/devin-system/frontend/devin_frontend/src/main.tsx',
                      type: 'file'
                    },
                    {
                      name: 'index.css',
                      path: '/home/ubuntu/devin-system/frontend/devin_frontend/src/index.css',
                      type: 'file'
                    }
                  ]
                }
        ...
        {
          name: 'backend',
          path: '/home/ubuntu/devin-system/backend',
          type: 'directory',
          expanded: false,
          children: [
            {
              name: 'devin_backend',
              path: '/home/ubuntu/devin-system/backend/devin_backend',
              type: 'directory',
              children: [
                {
                  name: 'app',
                  path: '/home/ubuntu/devin-system/backend/devin_backend/app',
                  type: 'directory',
                  children: [
                    {
                      name: 'main.py',
                      path: '/home/ubuntu/devin-system/backend/devin_backend/app/main.py',
                      type: 'file'
                    }
                  ]
                }
      ...
      <Tabs defaultValue="editor" className="flex flex-col h-full">
        ...
        <TabsContent value="terminal" className="flex-1 m-0 p-0">
          <div className="h-full bg-black text-white p-4 font-mono text-sm overflow-auto">
            <div className="text-green-500">ubuntu@devin:~$</div>
